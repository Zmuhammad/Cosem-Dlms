...
public class Clock
{
    ...
    public static void clock()
    {
        ...
        {
            0x7E, 0xA0, 0x20, 0x03, 0x03, 0x93, 0xFE, 0xC9, 0x81, 0x80, 0x14, 0x05, 0x02,
            0x05, 0x00, 0x06, 0x02, 0x05, 0x00, 0x07, 0x04, 0x00, 0x00, 0x00, 0x01, 0x08,
            0x04, 0x00, 0x00, 0x00, 0x01, 0x7F, 0x65, 0x7E
        };
        ...
        {
            0x7E, 0xA0, 0x44, 0x03, 0x03, 0x10, 0x65, 0x94, 0xE6,0xE6, 0x00, 0x60, 0x36,
            0xA1, 0x09, 0x06, 0x07, 0x60, 0x85, 0x74, 0x05, 0x08,0x01, 0x01, 0x8A, 0x02,
            0x07, 0x80, 0x8B, 0x07, 0x60, 0x85, 0x74, 0x05, 0x08,0x02, 0x01, 0xAC, 0x0A,
            0x80, 0x08, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37,0x38, 0xBE, 0x10, 0x04,
            0x0E, 0x01, 0x00, 0x00, 0x00, 0x06, 0x5F, 0x1F, 0x04,0x00, 0xFF, 0xFF, 0xFF,
            0x04, 0xFD, 0x1F, 0xA1, 0x7E
        };
        ...
        {
            0x7E, 0xA0, 0x19, 0x03, 0x03, 0x32, 0xEC, 0xC8, 0xE6, 0xE6, 0x00, 0xC0, 0x01,
            0x41, 0x00, 0x01, 0x00, 0x00, 0x2A, 0x00, 0x00, 0xFF, 0x01, 0x00, 0x61, 0x38,
            0x7E
        };
        ...
        // Send a DLMS/COSEM protocol request
        byte[] request4 = new byte[]
        {
            0x7E, 0xA0, 0x19, 0x03, 0x03, 0x54, 0xDC, 0xCE, 0xE6, 0xE6, 0x00, 0xC0, 0x01,
            0x41, 0x00, 0x01, 0x00, 0x00, 0x2A, 0x00, 0x00, 0xFF, 0x02, 0x00, 0x09, 0x12,
            0x7E
        };
...
public class Clock_Simulator
{
    ...
    // Main method
    public static void Clock_Simulator_Main()
    {
        ClockSimulator();
    }

    // Simulate the conversation between the device and the program
    public static void ClockSimulator()
    {
        // Frame 1
        ...
        byte[] sendFrame3 = new byte[]
        {
            ...
            0x00, 0x08, 0x00, 0x00, 0x01, 0x00, 0x00, 0xFF, 0x02, 0x00, 0x7B, 0x88, 0x7E
        };

        byte[] receiveFrame3 = new byte[]
        {
            0x7E, 0xA0, 0x1E, 0x03, 0x03, 0x52, 0xCB, 0xFC, 0xE6, 0xE7, 0x00, 0xC4, 0x01, 0x41,
            0x00, 0x09, 0x0C, 0x05, 0x7A, 0x03, 0x01, 0x01, 0x09, 0x33, 0x34, 0x00, 0xFF, 0x2E,
            0x00, 0xDD, 0xD9, 0x7E
        };
        ...
        string TranslateDLMSFrame(byte[] frame)
        {
            ...
            {
                // Check if is it the first frame or last frame
                if (frame[6] == 0xF0)
                {
            ...
            {
                translation.AppendLine("GET REQUEST: CLOCK,DATE,TIME = 1403-07-01 10:30:52");
            }
